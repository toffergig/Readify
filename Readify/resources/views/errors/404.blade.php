            ...
            <div class="relative">
                <div class="absolute">
                    <div class="">
                        ...
                        <p class="my-2 text-gray-800 dark:text-indigo-600">Sorry about that! Please visit our hompage to
                            get
                ...
                <div>
                    <img src="https://i.ibb.co/G9DC8S0/404-2.png" alt="error-img" />
                </div>
            </div>
        </div>
        <div>
            <img src="https://i.ibb.co/ck1SGFJ/Group.png" alt="error-img-2" />
        </div>
    </div>
</x-layout-blank>
